...
const TechCrunch = () => {
    ...
    useEffect(() => {
        const getComments = async () => {
            const res = await fetch(
                `https://newsapi.org/v2/everything?q=TechCrunch&apiKey=d2f5f511d7af43bc8189878f8ce74594&page=1&pageSize=${pageSize}`
            );
            const limit = await fetch(
                `https://newsapi.org/v2/everything?q=TechCrunch&apiKey=d2f5f511d7af43bc8189878f8ce74594&page=1`
            );
    ...
    const fetchComments = async (currentPage) => {
        const res = await fetch(
            `https://newsapi.org/v2/everything?q=TechCrunch&apiKey=d2f5f511d7af43bc8189878f8ce74594&page=${currentPage}&pageSize=${pageSize}`
    ...
    const handlePageClick = async (data) => {
        ...
        setTechCrunchNews(commentsFormServer.articles);
