...
const French = () => {
        ...
        const getCovidNews = async () => {
            try {
                const { data } = await axios.get(
                    `https://newsapi.org/v2/top-headlines?language=ar&pageSize=3&page=2&apiKey=00279f36e86d4a04bf15d9a84e4e31aa`
                );
    ...
    useEffect(() => {
        const getNews = async () => {
            try {
                const { data } = await axios.get(
                    `https://newsapi.org/v2/top-headlines?language=ar&pageSize=6&apiKey=00279f36e86d4a04bf15d9a84e4e31aa`
                );
